...
<html lang="en">
  <head>
    ...
    <script type="text/javascript">
        ...
        {
           var validPost = true;
           var postData = $("#PostTextarea").val()
            
            // Check if textarea is empty or is just spaces
    ...
    <div class="container">
      ...
      <div class="jumbotron">
        ...
        <div class="form-group">
                ...
                <form method="POST" onsubmit="return validatePost()" action="CreatePost">
                    <textarea class="form-control" id ="PostTextarea" name="postData" rows="6" placeholder="Enter a post"></textarea>
